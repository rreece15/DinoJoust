...
function Player4:init(map)
    ...
    self.x = map.mapWidth * map.tileWidth / 2
    self.y = map.mapHeight * map.tileHeight - (map.mapHeight * map.tileHeight / 5)

    self.dx = 0
    self.dy = 0

    self.texture = love.graphics.newImage('Graphics/yellow.png')
...
function Player4:checkRightCollision()
    if self.dx > 0 then
        -- check if there's a tile directly beneath us
...
function Player4:checkLeftCollision()
    if self.dx < 0 then
        -- check if there's a tile directly beneath us
...
function Player4:checkUpCollision()
    if self.dy < 0 then
        -- check if there's a tile directly beneath us
...
function Player4:checkDownCollision()
    if self.dy >= 0 then
        -- check if there's a tile directly beneath us
...
function Player4:render()
    ...
    if instructions == false then
        if self.score > 2 then
            love.graphics.draw(self.hearts, self.heart[3], (map.mapWidth * map.tileWidth) - (8 * map.tileWidth), (map.mapHeight * map.tileHeight) - (5 * map.tileHeight))
        else
            love.graphics.draw(self.hearts, self.heart[12], (map.mapWidth * map.tileWidth) - (8 * map.tileWidth), (map.mapHeight * map.tileHeight) - (5 * map.tileHeight))
        end

        if self.score > 1 then
            love.graphics.draw(self.hearts, self.heart[3], (map.mapWidth * map.tileWidth) - (10 * map.tileWidth), (map.mapHeight * map.tileHeight) - (5 * map.tileHeight))
        else
            love.graphics.draw(self.hearts, self.heart[12], (map.mapWidth * map.tileWidth) - (10 * map.tileWidth), (map.mapHeight * map.tileHeight) - (5 * map.tileHeight))
        end

        if self.score > 0 then
            love.graphics.draw(self.hearts, self.heart[3], (map.mapWidth * map.tileWidth) - (12 * map.tileWidth), (map.mapHeight * map.tileHeight) - (5 * map.tileHeight))
        else
            love.graphics.draw(self.hearts, self.heart[12], (map.mapWidth * map.tileWidth) - (12 * map.tileWidth), (map.mapHeight * map.tileHeight) - (5 * map.tileHeight))
        end
    end
end