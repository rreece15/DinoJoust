...
function Player3:init(map)
    ...
    self.y = (map.mapHeight * map.tileHeight / 5) - 5

    self.dx = 0
    self.dy = 0

    self.texture = love.graphics.newImage('Graphics/green.png')
...
function Player3:checkRightCollision()
    if self.dx > 0 then
        -- check if there's a tile directly beneath us
        ...
        elseif
            self.x + self.width >= VIRTUAL_WIDTH then
            self.dx = 0
...
function Player3:checkLeftCollision()
    if self.dx < 0 then
        -- check if there's a tile directly beneath us
...
function Player3:checkUpCollision()
    if self.dy < 0 then
        -- check if there's a tile directly beneath us
...
function Player3:checkDownCollision()
    if self.dy >= 0 then
        -- check if there's a tile directly beneath us
...
function Player3:render()
    ...
    if instructions == false then
        if self.score > 2 then
            love.graphics.draw(self.hearts, self.heart[4], 8 * map.tileWidth, (map.mapHeight * map.tileHeight) - (5 * map.tileHeight))
        else
            love.graphics.draw(self.hearts, self.heart[12], 8 * map.tileWidth, (map.mapHeight * map.tileHeight) - (5 * map.tileHeight))
        end

        if self.score > 1 then
            love.graphics.draw(self.hearts, self.heart[4], 6 * map.tileWidth, (map.mapHeight * map.tileHeight) - (5 * map.tileHeight))
        else
            love.graphics.draw(self.hearts, self.heart[12], 6 * map.tileWidth, (map.mapHeight * map.tileHeight) - (5 * map.tileHeight))
        end

        if self.score > 0 then
            love.graphics.draw(self.hearts, self.heart[4], 4 * map.tileWidth, (map.mapHeight * map.tileHeight) - (5 * map.tileHeight))
        else
            love.graphics.draw(self.hearts, self.heart[12], 4 * map.tileWidth, (map.mapHeight * map.tileHeight) - (5 * map.tileHeight))
        end
    end
end